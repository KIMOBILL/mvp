...
?>
<script src="layout/jquery/analisisdata.js" type="text/javascript"></script>
...
<div class="container-fluid ">
    <div class="row justify-content-end">   
        ...
        <div class="col-1">
            <select class="form-select" aria-label=".form-select-sm example" name="selectArea" id="selectArea" onchange="Calcular()"></select>
        </div>
        <div class="col-1">
...
<div class="container-fluid">
    <div class="row">        
            <select id="selectTvalor" onchange="tabledata()">
                <option value="TODOS" selected>MOSTRAR TODOS LOS COMENTARIOS</option>
                <option value="POSITIVA">CLASIFICAR SOLO COMENTARIOS POSITIVOS</option>
                <option value="NEGATIVA">CLASIFICAR SOLO COMENTARIOS NEGATIVOS</option>                
                <option value="NEUTRAL">CLASIFICAR SOLO COMENTARIOS NEUTRALES</option>
            </select>
    </div>
</div>
<div class="container-fluid">
